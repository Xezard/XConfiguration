...
{
    Optional<AbstractConfigurationData> getType(Class<?> clazz);

    Optional<AbstractConfigurationData> getType(Field field);

    void register(AbstractConfigurationData<?> configurationData);

    void remove(AbstractConfigurationData<?> configurationData);
}